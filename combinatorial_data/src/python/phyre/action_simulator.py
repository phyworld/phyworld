...
class ActionSimulator():
    ...
    def _simulate_user_input(
            ...
            stride, max_simulation_steps) -> Tuple[SimulationStatus, MaybeImages, MaybeObjects]:
    ...
    def simulate_action(self,
                        ...
                        *,
                        ...
                        stride: int = phyre.simulator.DEFAULT_STRIDE,
                        max_simulation_steps: int = phyre.simulator.DEFAULT_MAX_STEPS,
