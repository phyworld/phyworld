...
def build_task(C, seed):
    ...
    left_block = C.add('static ball', scale=0.04,                 
                    center_x=C.scene.width * (0.46 - seed * 0.0005),
                    center_y=C.scene.height * 0.3)
    
    right_block = C.add('static ball', scale=0.04,                 
                    center_x=C.scene.width * (0.54 + seed * 0.0005),
                    center_y=C.scene.height * 0.3)
