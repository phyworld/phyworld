...
def in_dist_generate():
    ...
    combinations1 = generate_combinations(low_r_list, v_list, color='red', object_type='circle')
    combinations2 = generate_combinations(high_r_list, v_list, color='red', object_type='rectangle')
...
def eval_dist_generate():
    ...
    combinations1 = generate_combinations(low_r_list, v_list, color='red', object_type='circle')
    combinations2 = generate_combinations(high_r_list, v_list, color='red', object_type='rectangle')
    combinations3 = generate_combinations(low_r_list, v_list, color='red', object_type='rectangle')
    combinations4 = generate_combinations(high_r_list, v_list, color='red', object_type='circle')
...
if __name__=='__main__':
    ...
    if not args.eval:
        ...
        args.data_dir = data_dir / f'size_shape_{size}'
        HDF5_SIZE=1000
        ...
        size = get_size_str(len(combinations))
        args.data_dir = data_dir / f'size_shape_eval_{size}'
        HDF5_SIZE=100
...
# python3 one_object_uniform_motion_size_shape.py --data_name in_dist_v2 --data_for_vis --num_workers 1
# python3 one_object_uniform_motion_size_shape.py --data_name in_dist_v2 --data_size_level 1 --num_workers 64
# python3 one_object_uniform_motion_size_shape.py --data_name in_dist_v2 --data_size_level 1 --num_workers 64 --eval