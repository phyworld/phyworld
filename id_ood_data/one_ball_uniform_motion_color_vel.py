...
if __name__=='__main__':
    ...
    if not args.eval:
        ...
        args.data_dir = data_dir / f'color_vel_{size}'
    else:
        # eval data
        combinations = eval_dist_generate()
        size = get_size_str(len(combinations))
        args.data_dir = data_dir / f'color_vel_eval_{size}'
    print(args.data_dir)
...
# python3 one_ball_uniform_motion_color_vel.py --data_for_vis --num_workers 1
# python3 one_ball_uniform_motion_color_vel.py --data_size_level 1 --num_workers 64
# python3 one_ball_uniform_motion_color_vel.py --data_size_level 1 --eval --num_workers 64